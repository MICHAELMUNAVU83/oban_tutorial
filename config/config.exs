...
config :oban_tutorial, ObanTutorialWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [
    formats: [html: ObanTutorialWeb.ErrorHTML, json: ObanTutorialWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: ObanTutorial.PubSub,
  live_view: [signing_salt: "mSGR5x00"]
...
config :oban_tutorial, ObanTutorial.Mailer, adapter: Swoosh.Adapters.Local
